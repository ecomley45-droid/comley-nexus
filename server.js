...
app.use(async (req, res, next) => {
  try {
    ...
    // Note: admin.nexuscmshub.com is redirected to nexuscmshub.com/super-admin
    // at the edge (vercel.json), so the authenticated app only ever runs on the
    // primary domain where Clerk sessions are stable. Requests on the admin
    // host never reach this function.
