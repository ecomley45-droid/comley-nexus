...
export function mountSocialApi(app) {
  ...
  // on localhost.
  app.get('/api/social/oauth/start', requireOrg, requireSocial, requirePermission('social', 'edit'), (req, res, next) => {
    try {
  ...
  app.delete('/api/social/accounts/:id', requireOrg, requireSocial, requirePermission('social', 'edit', 'accounts'), async (req, res, next) => {
    try { await accounts.disconnect(req.org.id, req.params.id); res.json({ success: true }); }
    catch (e) { next(e); }
  });

  app.post('/api/social/accounts/:id/refresh', requireOrg, requireSocial, requirePermission('social', 'edit', 'accounts'), async (req, res, next) => {
    try {
  ...
  app.post('/api/social/poll', requireOrg, requireSocial, requirePermission('social', 'edit'), async (req, res, next) => {
  ...
  app.post('/api/social/posts', requireOrg, requireSocial, requirePermission('social', 'edit'), async (req, res, next) => {
    try {
  ...
  app.post('/api/social/posts/:id/publish', requireOrg, requireSocial, requirePermission('social', 'edit'), async (req, res, next) => {
    try {
  ...
  app.delete('/api/social/posts/:id', requireOrg, requireSocial, requirePermission('social', 'edit'), async (req, res, next) => {
