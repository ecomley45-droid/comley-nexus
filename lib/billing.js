...
function assertStripe() {
  // User-facing message stays generic — no deployment/config detail. If this
  // fires when it shouldn't, the cause is a missing STRIPE_SECRET_KEY.
  if (!stripe) throw new Error('Billing is coming soon.');
}
