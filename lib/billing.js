...
import { mirrorBillingAccountToCore } from './coreBilling.js';
...
async function applySubscription(orgId, { plan, status, customerId, subscriptionId, periodEnd }) {
  ...
  // Additive dual-write into Core's billing_accounts (see lib/coreBilling.js)
  // -- best-effort, never blocks or fails this handler.
  await mirrorBillingAccountToCore(orgId, {
    plan: plan || undefined,
    status,
