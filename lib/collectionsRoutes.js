...
export function registerCollectionRoutes(app, { requireOrg, requireRole, auditFor }) {
  // ---- Collections -------------------------------------------------------
  ...
  app.post('/api/collections', requireOrg, requireRole('admin'), async (req, res, next) => {
    try {
  ...
  app.patch('/api/collections/:id', requireOrg, requireRole('admin'), async (req, res, next) => {
    try {
  ...
  app.delete('/api/collections/:id', requireOrg, requireRole('admin'), async (req, res, next) => {
    try {
  ...
  app.post('/api/collections/:id/entries', requireOrg, requireRole('editor'), async (req, res, next) => {
    try {
  ...
  app.patch('/api/collections/entries/:entryId', requireOrg, requireRole('editor'), async (req, res, next) => {
    try {
  ...
  app.delete('/api/collections/entries/:entryId', requireOrg, requireRole('editor'), async (req, res, next) => {
    try {
